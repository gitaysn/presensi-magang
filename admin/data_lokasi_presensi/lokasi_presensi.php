        ...
        <div class="page-body">
          ...
          <table class="table table-bordered mt-3">
            ...
            <?php if(mysqli_num_rows($result) === 0) { ?>
                <tr>
                    <td colspan="3">Data kosong, silahkan tambahkan data baru</td>
                </tr>
                <?php } else { ?>
                    <?php $no = 1; 
                        while($lokasi = mysqli_fetch_array($result)) :?>
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="<?= base_url('admin/data_lokasi_presensi/edit.php?id='.$lokasi['id']) ?>" class="badge bg-primary">Edit</a>
