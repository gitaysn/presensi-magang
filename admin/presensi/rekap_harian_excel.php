...
$result = mysqli_query($connection, "SELECT presensi.*, mahasiswa.nama, mahasiswa.lokasi_presensi, mahasiswa.kode FROM presensi 
...
while($data = mysqli_fetch_array($result)) {
    ...
    $sheet->setCellValue('C' . $row, $data['kode']);
