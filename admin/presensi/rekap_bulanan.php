...
$result = mysqli_query($connection, "SELECT presensi.*, mahasiswa.nama, mahasiswa.lokasi_presensi 
FROM presensi 
...
<div class="page-body">
    <div class="container-xl">
        ...
        <span>Rekap Presensi Bulan: <?= date('F Y', strtotime($filter_tahun_bulan)) ?></span>
