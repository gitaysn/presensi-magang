...
$result = mysqli_query($connection, "SELECT presensi.*, mahasiswa.nama, mahasiswa.lokasi_presensi, mahasiswa.kode
FROM presensi JOIN mahasiswa ON presensi.id_mahasiswa = mahasiswa.id WHERE DATE_FORMAT(tanggal_masuk, '%Y-%m') = '$filter_tahun_bulan' ORDER BY tanggal_masuk DESC");
